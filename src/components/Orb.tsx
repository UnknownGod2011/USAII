...
function hexToVec3(color: string) {
  ...
  if (rgbMatch) {
    return new Vec3(Number.parseInt(rgbMatch[1], 10) / 255, Number.parseInt(rgbMatch[2], 10) / 255, Number.parseInt(rgbMatch[3], 10) / 255);
  }
...
export function orbHueForStatus(status: "idle" | "listening" | "thinking" | "speaking") {
  switch (status) {
    case "listening":
      return 120;
    case "thinking":
